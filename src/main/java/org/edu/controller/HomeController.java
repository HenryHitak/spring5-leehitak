 ...
 * http://localhost:8080/ 요청을 받았을때, 변수를 만들어서 화면과 뿌려준다.
 */
/**
 * 
 * @author gmlxk
...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
	    ...
	    System.out.println("위에 Locale 클래스를 사용하ㅡㄴ 이유는 다국어 지원때문에 변수로 사용하게 됩니다.");
		...
		model.addAttribute("ServerTime", formattedDate );//serverTime 변수값으로 jsp 파일로 이동.
