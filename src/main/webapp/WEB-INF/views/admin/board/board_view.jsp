...
<%@ include file="../include/header.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <input value="${session_username}" type="text" class="form-control" name="replyer" id="replyer" placeholder="작성자를 입력해 주세요." required>                   <!-- 폼에서 input같은 입력태그에는 name속성이 반드시 필요, 이유는 DB에 입력할때,
