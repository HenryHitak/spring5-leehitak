          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<a href="member_list.html" class="btn btn-primary float-right mr-1">LIST ALL</a>
              	<button type="member_list.html" class="btn btn-danger float-right mr-1">DELETE</button>
				<button type="member_write.html" class="btn btn-warning float-right mr-1 text-white">UPDATE</button>              	
